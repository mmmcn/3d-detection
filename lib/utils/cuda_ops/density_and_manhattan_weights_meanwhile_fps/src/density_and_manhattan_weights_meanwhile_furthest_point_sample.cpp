...
int density_and_manhattan_weights_meanwhile_furthest_point_sampling_wrapper(int b, int n, int m,
                                                                            float alpha,
...
int density_and_manhattan_weights_meanwhile_furthest_point_sampling_wrapper(int b, int n, int m,
    ...
    cudaStream_t stream = at::cuda::getCurrentCUDAStream().stream();
    density_and_manhattan_weights_meanwhile_furthest_point_sampling_kernel_launcher(b, n, m, alpha,
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("density_and_manhattan_weights_meanwhile_furthest_point_sampling_wrapper",
        &density_and_manhattan_weights_meanwhile_furthest_point_sampling_wrapper,
