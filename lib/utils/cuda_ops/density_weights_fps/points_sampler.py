...
from .density_furthest_point_sample import (density_weights_furthest_point_sample,
...
class Points_Sampler_Density(nn.Module):
    """Points sampling.
    ...
    def __init__(self,
        ...
        super(Points_Sampler_Density, self).__init__()
        ...
        for fps_mod in fps_mod_list:
            ...
            if fps_mod != 'F-FPS':
                self.samplers.append(sampler(r[-1]))
            else:
...
class DFPS_Sampler(nn.Module):
    ...
    def forward(self, points, features, npoint):
        ...
        fps_idx = density_weights_furthest_point_sample(points.contiguous(), npoint, self.r)
        return fps_idx
...
class FS_Sampler(nn.Module):
    ...
    def forward(self, points, features, npoint):
        ...
        fps_idx_dfps = density_weights_furthest_point_sample(points, npoint, self.r)
