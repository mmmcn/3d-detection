...
int manhattan_weights_furthest_point_sampling_wrapper(int b, int n, int m,
...
void manhattan_weights_furthest_point_sampling_kernel_launcher(int b, int n, int m,
                                             const float *dataset, const float *weights,
...
int manhattan_weights_furthest_point_sampling_wrapper(int b, int n, int m,
  ...
  manhattan_weights_furthest_point_sampling_kernel_launcher(b, n, m, points, weights, temp, idx, stream);
  return 1;
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("manhattan_weights_furthest_point_sampling_wrapper", &manhattan_weights_furthest_point_sampling_wrapper,
        "manhattan_weights_furthest_point_sampling_wrapper");
